window.$docsify.plugins = [].concat((e, o) => {
	let t = {
		...
		bodyFontSize: "17px",
		dark: { accent: "#42b983", toogleBackground: "#ffffff", background: "#091a28", textColor: "#b4b4b4", codeTextColor: "#ffffff", codeBackgroundColor: "#0e2233", borderColor: "#0d2538", blockQuoteColor: "#858585", highlightColor: "#d22778", sidebarSublink: "#b4b4b4", codeTypeColor: "#ffffff", coverBackground: "linear-gradient(to left bottom, hsl(118, 100%, 85%) 0%,hsl(181, 100%, 85%) 100%)", toogleImage: "url(https://cdn.jsdelivr.net/npm/docsify-darklight-theme@latest/icons/sun.svg)" },
		light: { accent: "#42b983", toogleBackground: "#091a28", background: "#ffffff", textColor: "#34495e", codeTextColor: "#525252", codeBackgroundColor: "#f8f8f8", borderColor: "rgba(0, 0, 0, 0.07)", blockQuoteColor: "#858585", highlightColor: "#d22778", sidebarSublink: "#505d6b", codeTypeColor: "#091a28", coverBackground: "linear-gradient(to left bottom, hsl(118, 100%, 85%) 0%,hsl(181, 100%, 85%) 100%)", toogleImage: "url(https://cdn.jsdelivr.net/npm/docsify-darklight-theme@latest/icons/moon.svg)" },
	};
	...
	e.afterEach(function (e, o) {
        const objNav = Docsify.dom.find('nav');
        if (objNav && !document.getElementById('docsify-darklight-theme')) {
            const objLink = document.createElement('span');
            objLink.setAttribute('id', 'docsify-darklight-theme');
            objLink.style = 'display: inline-block;position: relative;top: auto;right: auto;margin: 0 1rem;';
            objNav.appendChild(objLink);
        }
		o((e = '' + e));
		...
		e.doneEach(function () {
            ...
            if(o.classList.contains('docsify-darklight-theme')) return;
			null !== o &&
				o.addEventListener("click", function () {
					"light" === t.defaultTheme ? d("dark") : d("light");
				});
                o.classList.add('docsify-darklight-theme');
		});
