...
<h3 class="text-xl font-semibold text-center mb-4">For financial documents</h3>
<p class="text-center">Ideal for invoices, contracts, acts and other financial documents where amounts need to be duplicated in words.</p>
</div>
...
<h3 class="text-xl font-semibold text-center mb-4">Instant conversion</h3>
<div class="text-center">

Simply enter the formula **PRICETOTEXT()** (`=PRICETOTEXT("123")`, `=PRICETOTEXT(A1)` or `=PRICETOTEXT(A1:A5)`) and get a ready-made result without any extra hassle.
...
<h3 class="text-xl font-semibold text-center mb-4">Reliability</h3>
<p class="text-center">Avoid errors when manually converting numbers. Our add-on is accuracy in every result.</p>
</div>
...
<div class="text-center mb-16">
<h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Main features</h1>
<div class="w-20 h-1 bg-theme-primary mx-auto mb-6"></div>
<p class="text-xl max-w-3xl" style="margin: auto;">Comfortable work with number to text conversion for Google Sheets™</p>
</div>
...
<h3 class="text-xl font-semibold" style="margin: 0;">Automatic translation</h3>
</div>
<p class="">Convert any numbers into corresponding text forms with accuracy to the penny.</p>
</div>
...
<h3 class="text-xl font-semibold" style="margin: 0;">Currency support</h3>
</div>
<p class="">Works with UAH, USD and RUB. Ability to choose the currency and language.</p>
</div>
...
<h3 class="text-xl font-semibold" style="margin: 0;">Flexible settings</h3>
</div>
<p class="">Customize the processing language, currency and choose a convenient conversion method.</p>
</div>
...
<h3 class="text-xl font-semibold" style="margin: 0;">Integration with Google Sheets™</h3>
</div>
<p class="">Works like a regular Google Sheets™ function. Updates automatically when data changes. Additionally, the add-on has a graphical interface integrated into the Google Sheets™ environment.</p>
</div>
...
<h3 class="text-xl font-semibold" style="margin: 0;">Support for large arrays of numbers</h3>
</div>
<p class="">Works with any range of table cells at once.</p>
</div>
...
<h3 class="text-xl font-semibold" style="margin: 0;">Ukrainian language</h3>
</div>
<p class="">Full support for the Ukrainian language with all peculiarities of numeral declension.</p>
</div>
...
<div class="text-center mb-16">
<h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why use it?</h1>
<div class="w-20 h-1 bg-theme-primary mx-auto mb-6"></div>
<p class="text-xl max-w-3xl" style="margin: auto;">Main advantages of our app for your work</p>
</div>
...
<div class="ml-4">
<h3 class="text-lg font-semibold" style="margin: 0;">Time saving</h3>
<p class="mt-2">Forget about manual conversion of numbers into words. Now it takes only a few seconds.</p>
</div>
</div>
...
<div class="ml-4">
<h3 class="text-lg font-semibold" style="margin: 0;">Accuracy</h3>
<p class="mt-2">Avoid errors that often occur during manual conversion of numbers.</p>
</div>
</div>
...
<div class="ml-4">
<h3 class="text-lg font-semibold" style="margin: 0;">Professional look</h3>
<p class="mt-2">Your documents will look more professional with properly formatted amounts.</p>
</div>
</div>
...
<div class="ml-4">
<h3 class="text-lg font-semibold" style="margin: 0;">Cloud solution</h3>
<p class="mt-2">You don't need to install anything on your computer. It works directly in the cloud through Google Sheets™.</p>
</div>
</div>
...
<div class="ml-4">
<h3 class="text-lg font-semibold" style="margin: 0;">Security</h3>
<p class="mt-2">Your data remains in your spreadsheets. We do not store or process your financial data.</p>
</div>
</div>
...
<div class="ml-4">
<h3 class="text-lg font-semibold" style="margin: 0;">Reliability</h3>
<p class="mt-2">A proven algorithm that takes into account all the features of the chosen language.</p>
</div>
</div>
...
<div class="text-center mb-16">
<h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Pricing</h1>
<div class="w-20 h-1 bg-theme-primary mx-auto mb-6"></div>
<p class="text-xl max-w-3xl" style="margin: auto;">Choose a plan that suits you best</p>
</div>
...
<p class="text-center text-white font-medium">Unique and unparalleled</p>
</div>
<div class="px-6 py-8">
<h3 class="text-2xl font-semibold text-center text-gray-800">Free</h3>
...
<span class="ml-2 text-gray-600">Unlimited conversions</span>
</li>
<li class="flex items-center">
<svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
</svg>
<span class="ml-2 text-gray-600">3 currencies (USD, RUB, UAH)</span>
</li>
<li class="flex items-center">
<svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
</svg>
<span class="ml-2 text-gray-600">Basic settings</span>
</li>
</ul>
</div>
<div class="px-6 pb-8">
...
<p class="">Need a corporate plan or custom solution? <a href="#/en/support" class="text-blue-600 hover:underline">Contact us</a></p>
</div>
...
<span>Ready! Now you can use the <strong>PRICETOTEXT()</strong> function and the app interface.</span>
</li>
</ol>
</div>
...
<li><a href="#/en/privacy-policy" class="text-gray-400 hover:text-white transition duration-300">Privacy Policy</a></li>
<li><a href="#/en/terms-of-service" class="text-gray-400 hover:text-white transition duration-300">Terms of Service</a></li>
<li><a href="#/en/support" class="text-gray-400 hover:text-white transition duration-300">Support</a></li>
</ul>
</div>
