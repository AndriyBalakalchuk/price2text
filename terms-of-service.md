...
Використання Додатку також регулюється нашою [Політикою конфіденційності](/privacy-policy), яка описує, як ми обробляємо (або, скоріше, не обробляємо) ваші дані. Будь ласка, ознайомтеся з нею.
...
- Через [сторінку підтримки](/support) на нашому сайті.
